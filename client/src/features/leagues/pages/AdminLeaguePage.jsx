...
export function AdminLeaguePage() {
  ...
  return (
    <main className="space-y-6 bg-[#F7F5F0] -m-4 p-4 md:-m-6 md:p-6">
      ...
      <section
        aria-label={displayedLeagueName}
      ...
      >
        ...
        <div className="relative flex items-center gap-4">
            ...
            {league.logo?.url ? (
              <>
                <CloudinaryImage
                  ...
                  sizes="64px"
                  className="h-16 w-16 rounded-full border-2 border-white/10 bg-white object-cover transition group-hover:opacity-60"
                />
                <span className="pointer-events-none absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full border-2 border-[#141414] bg-[#F4A300] shadow-sm transition group-hover:brightness-95">
                  <svg
                    viewBox="0 0 24 24"
              ...
              <span className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-dashed border-white/25 bg-white/5 text-white/40 transition group-hover:border-[#F4A300]/60 group-hover:text-[#F4A300]">
                {isUploadingLogo ? (
                  <svg
                    viewBox="0 0 24 24"
          ...
          <div className="min-w-0">
            ...
            {canEditLeague ? (
              <span className="mt-2 inline-flex max-w-full flex-wrap items-center gap-2">
                {isEditingLeagueName ? (
                  <>
                    <input
                      autoComplete="off"
                      ...
                      className="min-w-0 rounded-lg border border-white/20 bg-white/5 px-2 py-1 text-2xl leading-tight text-white md:text-3xl"
                    ...
                    <button
                      ...
                      className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/20 bg-white/5 text-white/80 transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      {isUpdatingLeague ? (
                        <svg
                          viewBox="0 0 24 24"
                  ...
                  <>
                    <span
                      className="truncate text-2xl text-white md:text-3xl"
                      style={{ fontFamily: "'Archivo Black', sans-serif" }}
                      aria-label="League Name"
                    >
                      {displayedLeagueName}
                    ...
                    <button
                      ...
                      className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/20 bg-white/5 text-white/60 transition hover:bg-white/10 hover:text-white"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        className="h-4 w-4"
            ...
            {logoError ? <p className="mt-2 text-xs text-[#F4A300]">{logoError}</p> : null}
          </div>
        </div>
      </section>
