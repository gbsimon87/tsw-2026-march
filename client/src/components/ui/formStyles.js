...
export const controlInvalidClass =
  'w-full rounded-lg border-2 border-red-400 bg-white px-3 py-2.5 text-sm text-slate-900 transition-colors focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-200';
