...
| —   | [OUTSTANDING-MANUAL-ACTIONS.md](./OUTSTANDING-MANUAL-ACTIONS.md) | **The single checklist of every human/infra action to finish + launch** |
...
| 3 · Stripe/env/render        | 🟩 Code done   | T-06 + T-07 code done 2026-07-16; suite 492/492. Infra/Stripe = [`OUTSTANDING-MANUAL-ACTIONS.md`](./OUTSTANDING-MANUAL-ACTIONS.md) (Round A)                                                         |
