...
| `registration_failed` | Registration rejected                        | `reason`: `email_in_use` \| `validation` \| `server_error`                              | **Server.** Distinguishes "chose not to" from "could not"; high `email_in_use` means returning users hit the wrong form |
